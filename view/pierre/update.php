    ...
    <form method="get" action="index.php" controller="pierre">
        <fieldset>
            ...
            <p>
                ...
                <input type="double" <?php echo "value=\"" . htmlspecialchars($prix) . "\"" ?> name="prix" id="prix_id" required/>
            </p>
            <p>
                <label for="volume">Volume (en cm cube)</label> :
                <input type="double" <?php echo "value=\"" . htmlspecialchars($volume) . "\"" ?> name="volume" id="volume_id" required/>
            </p>
            <p>
                <label for="poids">Poids (en grammes)</label> :
                <input type="double" <?php echo "value=\"" . htmlspecialchars($poids) . "\"" ?> name="poids" id="poids_id" required/>
            </p>
            <p>
                <label for="paysProvenance">Pays de provenance</label> :
                <input type="text" <?php echo "value=\"" . htmlspecialchars($paysProvenance) . "\"" ?> name="paysProvenance" id="paysProvenance_id" required/>
            </p>
            <p>
